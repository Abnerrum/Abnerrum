...
- 🔭 **Foco Atual:** Especialização em IA, análise de dados e automação de processos.
- ⚙️ **O que faço:** Transformo dados em insights e crio automações inteligentes com **n8n** e **Python**.
- 🎓 **Formação:** Gestão de TI.
- 💬 **Interesses:** Machine Learning, Engenharia de Dados e Exploração Espacial.
...
<div align="center">
  <table>
    <tr>
      <td align="center"><b>📊 Análise & BI</b></td>
...
*   📊 **TrackYourFit** - Sistema de monitoramento de métricas de saúde.
*   📋 **ImperioMultServiços** - Solução para gestão de múltiplos serviços.
*   🚀 **JovifyApp** - Aplicativo focado em produtividade e carreira.
